...
class Solution
{
  public:
    ...
    bool identical(Node* root,Node* subroot){
        ...
        return root->data==subroot->data and identical(root->left,subroot->left) and identical(root->right,subroot->right);
    ...
    bool isSubTree(Node* root, Node* subroot) 
    {
        ...
        return identical(root,subroot) or isSubTree(root->left,subroot) or 
